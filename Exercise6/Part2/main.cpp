...
{
    //------TASK 2
    processor cpu0("cpu0", "/home/danielg/SystemC/Exercise6/Part2/stimuli1.txt", sc_time(1, SC_NS));
    processor cpu1("cpu1", "/home/danielg/SystemC/Exercise6/Part2/stimuli2.txt", sc_time(1, SC_NS));
